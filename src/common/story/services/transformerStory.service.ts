...
export class TransformerStoryService {
   private locale;
   ...
   transformStoryList(docs, appendDetailData = {}, isTranslate = false, appendListData = {}) {
      const self = this;
      if (docs.docs) {
         docs.docs = docs.docs.map(function (doc) {
            return self.transformStoryDetail(doc, appendDetailData, isTranslate);
         });
         return {
            ...docs,
            ...appendListData,
   ...
   transformStoryDetail(doc, appendData = {}, isTranslate = false) {
   ...
   transformStoryExport(docs, appendData = {}, fileName?: string, customHeaders?: Array<string>) {
      return {
         excel: {
