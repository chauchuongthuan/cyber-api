...
export class TransformerCustomerService {
   ...
   transformCustomerDetail(doc, appendData = {}, isTranslate = false) {
      ...
      return {
         ...
         roleAssignedAt: doc.roleAssignedAt ? moment(doc.roleAssignedAt).format(DateTime.CREATED_AT) : null,
         lastReset: doc.lastReset ? moment(doc.lastReset).format(DateTime.CREATED_AT) : null,
